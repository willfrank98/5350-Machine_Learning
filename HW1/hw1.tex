...
\begin{framed}
	...
	Information gain of $x_1$ = $0.86 - (\frac{2}{3}(1.0) + \frac{1}{3}(0.0)) \approx 0.25 $
	
	Information gain of $x_3$ = $0.86 - (\frac{1}{3}(0.0) + \frac{2}{3}(1.0)) \approx 0.25 $
	
	Information gain of $x_4$ = $0.86 - (\frac{1}{3}(0.0) + \frac{2}{3}(0.0)) \approx 0.92 $
	...
	\includegraphics[scale=.9]{tree1.png}
	\centering
